...
// alert(password);
    var s={
name, service, city, contactno, email, password
    }
    console.log(s);
    axios.post('http://localhost:3000/create-vendors', s).then((res)=>{
                  ...
                  <div class="card shadow-lg border-0 rounded-lg mt-5">
                      ...
                      <div class="card-body">
                          ...
                          <div class="form-floating mb-3">
                              ...
                              <div class="form-floating mb-3">
                              <label for="enterService">Service</label>
                              <select id="enterService" name="Service" value={service} onChange={(e)=>{setValue(e)}}  >
